...
public class JDBCTemplate {
	...
	public static void commit(Connection conn) {
		...
		try {
			if(conn != null & !conn.isClosed()) { // conn객체가 빈 값이 아니거나, 반납을 하지 않은 경우
	...
	// 4. [Prepared]Statement관련 객체 전달받아서 반납해주는 메소드
	// Prepared Statement의 부모가 Statement이기 때문에 이걸로도 가능!  => 다형성 적용!
	...
	// 5. Connection객체 전달받아서 받납시켜주는 메소드
